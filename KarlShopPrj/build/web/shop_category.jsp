                                ...
                                <div class="widget_list widget_categories">
                                    ...
                                    <ul>
                                        <li><a href="product">All</a></li>
                                            ...
                                            <li><a href="product?action=listByCategory&category_id=${c.category_id}">
                                                    <c:if test="${c.category_id==CateID}">
                                                        <b>
                                                            ${c.category_name}
                                                        </b>
                                                    </c:if>
                            ...
                            <div class="shop_toolbar_wrapper" style="border:none">
                                <div class="dropdown ">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="product?action=sort&type=low">Price(low to high)</a>
                                        <a class="dropdown-item" href="product?action=sort&type=high">Price(high to low)</a>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12 ">
                                        <div class="single_product">
                                            <div class="product_thumb">
                                                <a class="primary_img" href="product?action=productdetail&product_id=${p.product_id}"><img  style="min-height:330px " src="${p.img}" alt=""></a>
                                            ...
                                            <div class="product_content grid_content">
                                                ...
                                                <span class="current_price"><p><fmt:formatNumber type="number" value="${p.product_price}"/> VND</p></span>
                                            </div>
                                        </div> 
                                   </div>
                                </c:forEach>
