                        ...
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" data-toggle="modal" data-target="#adddanhmuc"><i
                                            class="fas fa-folder-plus"></i> New category</a>
                                </div>
                            </div>
                            ...
                            <form class="row" action="productmanager?action=insertproduct" method="POST" enctype="multipart/form-data">
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" name="product_id"placeholder="SH123" type="text" placeholder="">
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group  col-md-3">
                                    ...
                                    <input class="form-control" name="price" placeholder="123000" type="number">
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group  col-md-3">
                                    ...
                                    <input class="form-control" name="quantity" placeholder="10" type="number">
                                </div>
