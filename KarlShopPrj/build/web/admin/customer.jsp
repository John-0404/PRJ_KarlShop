                                ...
                                <tbody>
                                    <c:forEach items="${user}" var="u">
                                        <tr>
                                            ...
                                            <th><button class="buttonDelete" style="border: none; background-color:#fbe2c5;padding: 5px 10px; border-radius:5px"><a href="customermanager?action=delete&user_id=${u.user_id}" style="color:rgb(245 157 57);font-size: 15px; "  ><i class="fas fa-trash"></a></button></th>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="exampleSelect1" class="control-label">Admin Permission</label>
