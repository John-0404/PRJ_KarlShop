    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="https://docs.google.com/spreadsheets/d/1m7oXCb-tZIskgmTpcMwocgcUHqDbkET0GsOPPyWQPsA/edit?usp=sharing" target="_blank"><i class='app-menu__icon bx bx-task'></i><span
                            class="app-menu__label">Check FeedBack</span></a></li>
            </ul>
        </aside>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="tile">
                                <h3 class="tile-title">Today Orders</h3>
                                <div>
