...
//            List<Entity.Product> product = c.getListByPage(productList, start, end);
            List<Entity.Product> product = c.getCollection();
        ...
        if (action.equals("sort")) {
            ...
            if (type.equals("low")) {
                productDAO c = new productDAO();
                List<Entity.Product> productList = c.getCollectionProductToHigh();
                List<Category> category = c.getCategory();
                int page, numperpage = 9;
                int size = productList.size();
                int num = (size % 9 == 0 ? (size / 9) : ((size / 9)) + 1);//so trang
            ...
            if (type.equals("high")) {
                productDAO c = new productDAO();
                List<Entity.Product> productList = c.getCollectionProductToLow();
                List<Category> category = c.getCategory();
                int page, numperpage = 9;
                int size = productList.size();
                int num = (size % 9 == 0 ? (size / 9) : ((size / 9)) + 1);//so trang
            ...
            if (type.equals("a-z")) {
                productDAO c = new productDAO();
                List<Entity.Product> productList = c.getCollectionProductAZ();
                List<Category> category = c.getCategory();
                int page, numperpage = 9;
                int size = productList.size();
                int num = (size % 9 == 0 ? (size / 9) : ((size / 9)) + 1);//so trang
